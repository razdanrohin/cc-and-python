...
# Generated: Thu Sep  6 14:12:09 2018
##################################################
...
class gfsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.channels_fading_model_0, 0), (self.digital_gfsk_demod_0, 0))
        ...
        self.connect((self.digital_gfsk_mod_0, 0), (self.channels_fading_model_0, 0))
