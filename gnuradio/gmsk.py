...
# Title: Rohin_Razdan
# Author: rohin_razdan - 2015120039
# Generated: Thu Sep  6 19:54:32 2018
##################################################
...
class gmsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Rohin_Razdan")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rohin_Razdan")
        ...
        self.channels_fading_model_0 = channels.fading_model( 8, 10.0/samp_rate, False, 4, 0 )
        ...
        self.connect((self.blks2_packet_decoder_0, 0), (self.qtgui_sink_x_1, 0))
        self.connect((self.blks2_packet_encoder_0, 0), (self.digital_gmsk_mod_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blks2_packet_encoder_0, 0))
        self.connect((self.channels_fading_model_0, 0), (self.digital_gmsk_demod_0, 0))
        self.connect((self.channels_fading_model_0, 0), (self.qtgui_const_sink_x_0, 1))
        self.connect((self.digital_gmsk_demod_0, 0), (self.blks2_packet_decoder_0, 0))
        self.connect((self.digital_gmsk_mod_0, 0), (self.channels_fading_model_0, 0))
